...
export const t = {
  ...
  noCreatableCategoryHelp:
    'مدیر سامانه دسترسی محتوا را جدا از نقش ادمین می‌دهد. برای ثبت سند باید روی یک پوشه دسترسی «ثبت سند» داشته باشید.',
  noCreatableCategoryAdminHint: 'از مدیریت پوشه‌ها می‌توانید برای خودتان یا دیگران دسترسی بدهید.',
  grantMyselfCreate: 'اعطای دسترسی ثبت به من روی پوشه‌ی ریشه',
  grantMyselfCreateDone: 'دسترسی داده شد؛ می‌توانید سند ثبت کنید.',
