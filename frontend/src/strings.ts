...
export const t = {
  ...
  noCreatableCategory: 'در هیچ پوشه‌ای اجازه‌ی ثبت سند ندارید.',
  noCreatableCategoryHelp:
    'برای باز شدن فرم ثبت سند، روی همان پوشه هم «دیدن سند» و هم «ثبت سند» لازم است (یکی به‌تنهایی کافی نیست). پس از اعطا، دوباره به این صفحه بیایید.',
  noCreatableCategoryAdminHint:
    'نقش مدیر به‌تنهایی دسترسی محتوا نمی‌دهد. یا از دکمهٔ زیر روی پوشهٔ ریشه به خودتان دسترسی بدهید، یا در مدیریت پوشه‌ها «اعطای دسترسی ثبت سند» را بزنید.',
  grantMyselfCreate: 'اعطای دسترسی ثبت به من روی پوشه‌ی ریشه',
  grantMyselfCreateDone: 'دسترسی داده شد؛ فرم ثبت باز می‌شود.',
  openCategoriesAdmin: 'مدیریت پوشه‌ها و دسترسی‌ها',
